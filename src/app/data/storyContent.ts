...
export const oracleQuestions: Question[] = [
  {
    ...
    options: [
      { id: "1a", text: "Clarity and understanding" },
      { id: "1b", text: "Change and transformation" },
      { id: "1c", text: "Answers to unspoken questions" },
      { id: "1d", text: "A connection to something greater" },
    ],
  },
  {
    question: "What is calling to you most strongly right now?",
    options: [
      { id: "2a", text: "The unknown" },
      { id: "2b", text: "A memory you can’t forget" },
      { id: "2c", text: "A dream you want to explore" },
      { id: "2d", text: "A truth waiting to be uncovered" },
    ],
  },
  {
    question: "What guides your steps forward?",
    options: [
      { id: "3a", text: "Curiosity" },
      { id: "3b", text: "Courage" },
      { id: "3c", text: "Intuition" },
      { id: "3d", text: "A sense of purpose" },
    ],
  },
  {
    question: "What do you feel you’ve left behind?",
    options: [
      { id: "4a", text: "Something unresolved" },
      { id: "4b", text: "A piece of yourself" },
      { id: "4c", text: "A fleeting moment of joy" },
      { id: "4d", text: "A weight you’re ready to let go of" },
    ],
  },
  {
    question: "Which path feels most like yours?",
    options: [
      { id: "5a", text: "One that twists and turns unpredictably" },
      { id: "5b", text: "A steady road toward the horizon" },
      { id: "5c", text: "A path lit by faint and shifting light" },
      { id: "5d", text: "A hidden trail through shadow and silence" },
    ],
  },
  {
    question: "What do you hope to find on this journey?",
    options: [
      { id: "6a", text: "A hidden truth" },
      { id: "6b", text: "Strength you didn’t know you had" },
      { id: "6c", text: "A sense of belonging" },
      { id: "6d", text: "The ability to move forward" },
    ],
  },
  {
    question: "Which archetype feels most like you right now?",
    options: [
      { id: "7a", text: "The Seeker: Always searching, always curious" },
      {
        id: "7b",
        text: "The Healer: Bringing light to shadows and mending what is broken",
      },
      {
        id: "7c",
        text: "The Dreamer: Guided by imagination and boundless possibility",
      },
      {
        id: "7d",
        text: "The Protector: Strong, steadfast, and a guardian of others",
      },
    ],
  },
  {
    ...
    options: [
      { id: "8a", text: "Hopeful" },
      { id: "8b", text: "Curious" },
      { id: "8c", text: "Uncertain" },
      { id: "8d", text: "Quietly determined" },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      { id: "10a", text: "Reflection" },
      { id: "10b", text: "Transformation" },
      { id: "10c", text: "Connection" },
      { id: "10d", text: "Revelation" },
    ],
  },
];
